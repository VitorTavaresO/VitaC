...
<?php
    ...
    $sql = "SELECT * FROM activitiespost WHERE idactivitiespublic=$idpublic;";
        ...
        <div class="row">
          <div class="col-xl-9 col-lg-10 mx-auto">
            <div class="bg-faded rounded p-5">
              ...
              <form action ="activities_edit.php"method="POST" enctype="multipart/form-data" id="form-publicar">
                 ...
                 <?php
              print "<article>";
              print "<a href='activities_delete.php?idpublic=$idpublic'><input type='button' value='Excluir' class='btn btn-primary btn-xl2'></a>";
              print "</article>";
                ?>
              </form>
            </div>
