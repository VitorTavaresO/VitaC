        ...
        <div class="row">
          <div class="col-xl-9 col-lg-10 mx-auto">
            <div class="bg-faded rounded p-5">
              ...
              <form action ="sponsors_creation.php"method="POST" enctype="multipart/form-data" id="form-publicar">
                 <h2> Imagem: </h2><input type="file" name="userfile" class=""><br><br><br> 
                 </h2>
                 <h2>Link:</h2><pre><textarea type="text" name="url" class="adminTextCamp2" rows="100000"></textarea></pre>
