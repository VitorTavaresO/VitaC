        ...
        <div class="row">
          <div class="col-xl-9 col-lg-10 mx-auto">
            <div class="bg-faded rounded p-5">
              ...
              <form action ="activities_creation.php"method="POST" enctype="multipart/form-data" id="form-publicar">
                 <span class="section-heading-lower"> <b>Título: <input type="text" name="titulo" class="adminTextCamp" required autofocus></b></span>
                 </h2>
                 <textarea type="text" name="post" class="adminTextCamp2" rows="100000000"></textarea>
